...
bool Save(const char * filename)
{
	...
	file << Indigo::Current_World.View.X << "|" << Indigo::Current_World.View.Y << "|" << Indigo::Current_World.View.Z
		<< "|" << Indigo::Current_World.View.Eye.Get_X_Angle() << "|" << Indigo::Current_World.View.Eye.Get_Y_Angle()
...
bool Save_For_Compile(const char * filename)
{
	...
	file << "Indigo::Current_World.View.Eye.Set_Direction(1, " << Indigo::Current_World.View.Eye.Get_X_Angle() << ", " << Indigo::Current_World.View.Eye.Get_Y_Angle() << ");" << std::endl;
	for (int i = 0; i < Indigo::Current_World.Number_Of_Objects(); ++i)
	{
		Object& object = Indigo::Current_World.Get_Object(i);
		if (object.Data.Size != 0)
	...
	else
	{
		...
		if (Indigo::Control)
		{
			...
			if (key == 'v') // Paste
			{
				if (Copied != -1)
				{
					int place = Indigo::Current_World.Add_Object(Indigo::Current_World.Get_Object(Copied));
					To_Move = &Indigo::Current_World.Get_Object(Copied); // All object references are invalidated when things are added
