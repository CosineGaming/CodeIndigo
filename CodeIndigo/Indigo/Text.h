...
public:
	...
	Text(const float text_x=0, const float text_y=0, char * display="", float * color = nullptr, void * font = nullptr, const float time_to_last = -1, void(*finished)(void)=nullptr);
