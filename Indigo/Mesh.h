...
public:
	...
	static Mesh Rectangle(const float width, const float height, const char * texture = nullptr, const char * bump_map = nullptr, const bool stretch_texture = false, const int reduce_filter = GL_LINEAR_MIPMAP_LINEAR, const int enlarge_filter = GL_LINEAR);
