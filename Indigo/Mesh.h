...
public:
	...
	static Mesh Rectangle(const float width, const float height, const char * texture = nullptr, const char * bump_map = nullptr, const bool normalize_texture = true, const int reduce_filter = GL_LINEAR_MIPMAP_LINEAR, const int enlarge_filter = GL_LINEAR);
	...
	static Vertex_Data Rectangle_Vertices(const float width, const float height, const bool normalize_texture = true);
